...
function path_disclosure($url){
	...
	//Wf    ,@`      ][      '@.    VW
	//M.    W`  _mm_ ][ _mm_  'W    ,A
	//'W   ][  i@@@@i][i@@@@i  ][   W`    LittelFey
	// !b  @   !@@@@!][!@@@@!   @  d!  Auto CMS Detector
	//  VWmP    ~**~ ][ ~**~    YmWf     @virusaworm
	//    ][         ][         ][
	//  ,mW[         ][         ]Wm.
	// ,A` @  ,gms.  ][  ,gms.  @ 'M.
	// W`  Yi W@@@W  ][  W@@@W iP  'W
...
'Ms    VW.     ][     ,Wf    gA`
  VW.   'Ms.   ][   ,gA`   ,Wf
   'Ms    'V*mmWWmm*f`    gA`\n\x1b\033\n\x1b[1;91m     Vworm toolkit - Reinz v1.0\n\x1b\033[1;97m     cms wordpress autodetect"."\033[0m".PHP_EOL;
